...
//
// Il valore dichiarato porta il prefisso static:/url: (29/07/2026,
// vedi ImageReference): qui si risolve solo il caso static:, un url:
// non ha ancora un caricamento di rete e degrada sul default come un
// nome sconosciuto qualunque.
@DrawableRes
fun sceneBackgroundRes(name: String?): Int {
